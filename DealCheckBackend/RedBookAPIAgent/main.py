...
def main():
    ...
    description = user_input["car_details"]["description"]
    ...
    filters = {
    "Manufacturer": user_input["car_details"]["make"],
    "Model": user_input["car_details"]["model"],
    "Prod. year": user_input["car_details"]["year"],
    "Mileage": user_input["car_details"]["mileage"],
    ...
    if user_input["pricing"]["listed_price"]  <= float(price)*1.05:
        print("Good Deal")
    else:
        print("Bad Deal")
